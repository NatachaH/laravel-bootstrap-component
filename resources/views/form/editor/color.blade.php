<div class="ql-formats btn-group">
    ...
    <button type="button" class="btn dropdown-toggle ql-dropdown-color" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="@lang('bs-component::editor.color')">
