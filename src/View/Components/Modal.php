...
class Modal extends Component
{
     ...
     * @return void
     */
    public function __construct($title = null, $footer = null, $size = 'md', $closable = false, $centered = false, $scrollable = false, $fullscreen = false, $fullscreenSize = null, $isStatic = false)
    {
        $this->title                = $title;
        $this->footer               = $footer;
        $this->size                 = $size;
